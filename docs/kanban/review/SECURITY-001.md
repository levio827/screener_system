# SECURITY-001: Fix js-yaml Prototype Pollution Vulnerability (CVE)
...
| TBD | PR #145 merged | Pending |
| TBD | Alert automatically resolved | Pending |
...
- [ ] PR #145 approved and merged
- [ ] Dependabot Alert #30 closed
