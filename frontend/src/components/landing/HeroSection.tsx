      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center">
          ...
          <h1 className="text-5xl sm:text-6xl font-bold text-gray-900 mb-6 leading-tight">
            한국 주식 시장,
            <br />
            <span className="text-blue-600">데이터로 분석하세요</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mb-12">
            <Link
              to="/screener"
              className="px-8 py-4 bg-blue-600 text-white text-lg font-semibold rounded-lg hover:bg-blue-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
            >
              무료로 시작하기
            </Link>
            <Link
              to="/market"
              className="px-8 py-4 bg-white text-blue-600 text-lg font-semibold rounded-lg hover:bg-gray-50 transition-all duration-200 shadow-md hover:shadow-lg border-2 border-blue-600"
            >
              시장 둘러보기
            </Link>
          </div>
        ...
        <div className="mt-16 relative">
          <div className="absolute inset-0 bg-gradient-to-r from-blue-400 to-blue-600 rounded-2xl transform rotate-1 opacity-10"></div>
